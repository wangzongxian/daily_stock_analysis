...
- [修复] 收敛 #1391 Phase 0 A 股代码归属边界：补齐 `SH`/`SZ` 前缀场景的归属一致性，明确 `data_provider/base.py`、`data_provider/baostock_fetcher.py`、`data_provider/tushare_fetcher.py` 的本轮修复范围，并回归 `data_provider/pytdx_fetcher.py` 的既有前缀行为。
